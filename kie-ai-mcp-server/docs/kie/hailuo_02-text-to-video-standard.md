# 02 Text To Video Standard API Documentation

> Generate content using the 02 Text To Video Standard model

## Overview

This document describes how to use the 02 Text To Video Standard model for content generation. The process consists of two steps:
...
|-----------|------|----------|-------------|
| model | string | Yes | Model name, format: `hailuo/02-text-to-video-standard` |
...
|----------|-------|-------------|
| **Format** | `hailuo/02-text-to-video-standard` | The exact model identifier for this API |
...
- **Default Value**: `"A llama and a raccoon battle it out in an intense table tennis match, inside a roaring Olympic stadium. Slow-mo, wild angles, full comedy mode."`
...
```json
{
  ...
  "data": {
    ...
    "model": "hailuo/02-text-to-video-standard",
    "state": "waiting",
    "param": "{\"model\":\"hailuo/02-text-to-video-standard\",\"input\":{\"prompt\":\"A llama and a raccoon battle it out in an intense table tennis match, inside a roaring Olympic stadium. Slow-mo, wild angles, full comedy mode.\",\"duration\":\"6\",\"prompt_optimizer\":true}}",
    "resultJson": "{\"resultUrls\":[\"https://file.aiquickdraw.com/custom-page/akr/section-images/175852441202970pyirpe.mp4\"]}",
    "failCode": null,
    "failMsg": null,
    "costTime": null,
    "completeTime": null,
