...
> Generate content using the Remove Background model

## Overview

This document describes how to use the Remove Background model for content generation. The process consists of two steps:
...
|-----------|------|----------|-------------|
| model | string | Yes | Model name, format: `recraft/remove-background` |
...
|----------|-------|-------------|
| **Format** | `recraft/remove-background` | The exact model identifier for this API |
...
- **Default Value**: `"https://file.aiquickdraw.com/custom-page/akr/section-images/1757057285447k9qcbki1.webp"`
...
```json
{
  ...
  "data": {
    ...
    "model": "recraft/remove-background",
    "state": "waiting",
    "param": "{\"model\":\"recraft/remove-background\",\"input\":{\"image\":\"https://file.aiquickdraw.com/custom-page/akr/section-images/1757057285447k9qcbki1.webp\"}}",
    "resultJson": "{\"resultUrls\":[\"https://file.aiquickdraw.com/custom-page/akr/section-images/1757057316650rbh63xqi.png\"]}",
    "failCode": null,
    "failMsg": null,
    "costTime": null,
    "completeTime": null,
